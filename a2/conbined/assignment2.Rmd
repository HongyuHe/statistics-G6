...
qqnorm(ages, col = "darkgoldenrod3")
qqline(ages, col = "red", lwd=2) 
abline(as.numeric(mean_titanic), sd_titanic, col = "blue", lwd=2)
...
qqnorm(chol, col = "darkgoldenrod3")
qqline(chol, col = "red", lwd=2) 
abline(as.numeric(mean_chol), sd_chol, col = "blue", lwd=2)
...
qqnorm(bwt, col = "darkgoldenrod3")
qqline(bwt, col = "red", lwd=2)
abline(as.numeric(mean_bwt), sd_bwt, col = "blue", lwd=2)
